        ...
        <div className="min-h-screen bg-slate-900">
                    ...
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center gap-8">
                            ...
                            <div className="flex gap-4">
                                ...
                                <Link href="/admin/venues" className="text-white bg-slate-700 px-3 py-2 rounded-lg text-sm">🏛️ Venues</Link>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <main className="max-w-7xl mx-auto px-4 py-8">
                <div className="flex items-center justify-between mb-8">
                    <h2 className="text-2xl font-bold text-white">🏛️ Venues ({total})</h2>
                    <input
                        type="text"
                        ...
                        <table className="w-full">
                            <thead className="bg-slate-700/50">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 text-left text-xs font-medium text-slate-400 uppercase">Adres</th>
                                    <th className="px-4 py-3 text-left text-xs font-medium text-slate-400 uppercase">Kapasite</th>
                                    <th className="px-4 py-3 text-right text-xs font-medium text-slate-400 uppercase">İşlemler</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-700">
                                {venues.map((venue) => (
                                    <tr key={venue.id} className="hover:bg-slate-700/30">
